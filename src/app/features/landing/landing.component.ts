...
const CATEGORY_ICONS: Array<{
  ...
  { id: 'image-to-image', label: 'Img→Img', hubPath: '/image-to-image', emoji: '✨', bg: '#DFF7E8' },
  { id: 'fine-tune', label: 'Fine-tune', hubPath: '/fine-tune', emoji: '🧪', bg: '#FFE8D6' },
  { id: 'inference', label: 'Inference', hubPath: '/inference', emoji: '⚡', bg: '#FFF0C8' },
  ...
  { id: 'hire-marketing', label: 'Marketing', hubPath: '/hire-marketing', emoji: '📣', bg: '#FFE4F0' },
  { id: 'hire-seo', label: 'SEO', hubPath: '/hire-seo', emoji: '🔎', bg: '#E4FFF0' },
  { id: 'dataset', label: 'Dataset', hubPath: '/dataset', emoji: '📚', bg: '#FFF5D6' },
];
