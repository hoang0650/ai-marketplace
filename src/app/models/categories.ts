import { CategoryGroup, CategoryMeta, ProductCategory } from '../models/marketplace.models';
...
/** Hub categories: RunPod modalities + skill packs + hiring roles */
export const CATEGORY_META: CategoryMeta[] = [
  ...
  },
  {
    id: 'skill-pack',
    label: 'Skill packs',
    description: 'Buy & sell OpenClaw / agent skill bundles (SKILL.md + tools).',
    hubPath: '/skill-pack',
    group: 'skills',
  },
  {
  ...
  },
  {
    id: 'hire-marketing',
    label: 'Marketing',
    description: 'Hire marketers for campaigns, ads, and growth.',
  ...
  },
  {
    id: 'hire-seo',
    label: 'SEO',
    description: 'Hire SEO specialists for search growth.',
    hubPath: '/hire-seo',
    group: 'hire',
  },
  {
    id: 'hire-creator',
    label: 'Creator',
    description: 'Hire content creators, editors, and UGC talent.',
  ...
  },
  {
    ...
    description: 'Hire specialists to automate ops with n8n, Zapier, Make, OpenClaw.',
  ...
  },
  {
    id: 'hire-build-app',
    label: 'Build app',
    description: 'Hire teams to design and ship mobile / desktop apps.',
  ...
  },
  {
    id: 'hire-build-web',
    label: 'Build web',
    description: 'Hire teams to build marketing sites, dashboards, and web apps.',
